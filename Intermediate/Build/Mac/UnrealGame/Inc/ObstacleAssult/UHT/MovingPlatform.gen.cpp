...
struct Z_Construct_UClass_AMovingPlatform_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MyInt2_MetaData[] = {
		{ "Category", "MovingPlatform" },
		{ "ModuleRelativePath", "MovingPlatform.h" },
	};
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_AMovingPlatform_Statics::NewProp_MyInt2 = { "MyInt2", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMovingPlatform, MyInt2), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MyInt2_MetaData), NewProp_MyInt2_MetaData) };
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_javivillarreal_Documents_Unreal_Projects_ObstacleAssult_ObstacleAssult_Source_ObstacleAssult_MovingPlatform_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMovingPlatform, AMovingPlatform::StaticClass, TEXT("AMovingPlatform"), &Z_Registration_Info_UClass_AMovingPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMovingPlatform), 373372978U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_javivillarreal_Documents_Unreal_Projects_ObstacleAssult_ObstacleAssult_Source_ObstacleAssult_MovingPlatform_h_865417826(TEXT("/Script/ObstacleAssult"),
	Z_CompiledInDeferFile_FID_javivillarreal_Documents_Unreal_Projects_ObstacleAssult_ObstacleAssult_Source_ObstacleAssult_MovingPlatform_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_javivillarreal_Documents_Unreal_Projects_ObstacleAssult_ObstacleAssult_Source_ObstacleAssult_MovingPlatform_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
